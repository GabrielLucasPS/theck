    ...
    if (session?.user.role == "ADMIN") {
                ...
                <div className="flex flex-col">
                    ...
                    <div className=" bg-slate-300 py-[40px] px-[30px] rounded-lg h-fit">
                        <div className="flex justify-evenly items-center">
                            <div>
                                <h2 className="text-3xl font-bold mb-10">Criar Entrega</h2>
                                <NewEntregaForm />
                            </div>
                        </div>
                    </div>

                    <div className="mt-10 bg-slate-300 py-[40px] px-[30px] rounded-lg h-fit">
                        <h2 className="text-3xl font-bold mb-10">Editar Localização atual</h2>
                    </div>

                </div>
                <div className="flex flex-col">
                    <div>
                        <h3 className="text-3xl font-bold text-slate-800">Minhas Entregas</h3>
                    </div>
        ...
        return (
            <h2 className="text-2xl">
                Ir para a
                <Link className="m-10 p-5 bg-red-600 rounded-md" href="/">Home</Link>
            </h2>
        )
    }
