...
const TodasEntregas = ({ entrega, session }: Props) => {
    ...
    return (
        <div>
            <div className='mb-[20px] p-4 bg-slate-900 border-2 border-black rounded-md w-[900px] mr-[20px]'>
                ...
                <div className=" justify-between flex mb-4">
                    ...
                    {session?.user.role === "ADMIN" ?
                        <div>
                            <p className='text-xl font-bold text-gray-50'>Ultima localização:</p>
